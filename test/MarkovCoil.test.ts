  ...
  describe("predictions", () => {
    describe("map to weights is correct", () => {
      ...
      test("for depth=1", () => {
        ...
        expect(markov.predictions(["the"])).toEqual({
          the: 0.5,
          dog: 0.25,
          fox: 0.25,
        });
      ...
      test("for depth=2", () => {
        const markov = new MarkovCoil(
          "the dog and the dog friend".split(" "),
          2,
        );
        expect(markov.predictions(["the", "dog"])).toEqual({
          and: 0.5,
          friend: 0.5,
        });
      });
    ...
    describe("for single token", () => {
      test("are correct", () => {
        const markov = new MarkovCoil(
          "the quick brown fox and the lazy dog".split(" "),
        );
    ...
    describe("for sequence", () => {
      test("are correct", () => {
        ...
        expect(markov.predictSequence(["the", "quick"], 5)).toEqual(
          "brown fox and the lazy".split(" "),
        );
      });
    });
  });
